loadstring(game:HttpGet(("https://raw.githubusercontent.com/VanThanhIOS/OniiChanVanThanhIOS/refs/heads/main/uimain.txt")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "NQM DZ Tổng hợp",
         Animation = "Script Tổng Hợp Ver1"
         },
        Key = {
        KeySystem = true,
        Title = "NQM DZ / Scrpit Tổng Hợp",
        Description = "",
        KeyLink = "https://yeumoney.com/nobgMjR",
        Keys = {"ab380e304154b9183366e85610bbc120"},
        Notifi = {
        Notifications = true,
        CorrectKey = "Đang Chạy Kịch Bản",
       Incorrectkey = "Mật Khẩu Đúng",
...
local Window = Library:CreateWindow('NQM DZ / Ver_3[PREMIUM]')
...
Changelog:addChangelog('Menu : NQM DZ ')
Changelog:addChangelog('Thông Tin Liên Hệ')
Changelog:addChangelog('YTB: @ltn fifai ')
Changelog:addChangelog('Tik Tok: @boy27th5_')
Changelog:addChangelog('FB : @Lê Thiện Nhân')
...
FastAttack = true
Main_Setting:addToggle('Fast Attack (Melee,Sword and Gun)', FastAttack, function(Value)
    FastAttack = Value
end)
spawn(function()
    while task.wait() do
...
local AttackList = {"0.400 (Risk)", "0.465", "0.575 (Default)", "0.685", "0.700", "0.800", "0.900", "1000 (Slow)"}
FastAttackSelected = "1000 (Default)"
...
spawn(function()
    while task.wait() do
        if FastAttackSelected == "0600 (Risk)" then
            FastAttackDelay = 0.6
        elseif FastAttackSelected == "0.665" then
            FastAttackDelay = 0.665
        elseif FastAttackSelected == "0.775 (Default)" then
            FastAttackDelay = 0.775
        elseif FastAttackSelected == "0.885" then
            FastAttackDelay = 0.885
        elseif FastAttackSelected == "0.700" then
            FastAttackDelay = 0.7
        elseif FastAttackSelected == "0.800" then
            FastAttackDelay = 0.8
        elseif FastAttackSelected == "0.900" then
            FastAttackDelay = 0.9
        elseif FastAttackSelected == "1000 (Slow)" then
            FastAttackDelay = 1.0
        end
    end
end)
